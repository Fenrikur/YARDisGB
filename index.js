...
client.on('message', message => {
	...
	if (message.content.startsWith(prefix)) {
		...
		if (!game.word_morphing.allowSameUser && message.author.id === previousMessage.author.id) {
			message.react('❌');
